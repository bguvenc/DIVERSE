...
for t in range(5):
    with open("folds_in/folds_1/folds_train_exp_{}_1.csv".format(t), "r+") as f_train:
    ...
    with open("folds_in/folds_1/folds_test_exp_{}_1.csv".format(t), "r+") as f_test:
...
def run_all_settings(alpha):
    fout = open('folds_1_in_matrix_results.txt','w')
...
#####PD + DD variations (integrate drug similarity data)
    ...
    for j in range(5):
        ...
        for i in range(5):
            M_train = M_Y_training_folds[i]
            M_test = M_Y_test_folds[i]
            ...
            with open("predicted_data_in/folds_1_predicted/dd/R_pred_dd_par_{}_fold_{}.csv".format(j,i), "w") as f:
    ...
    #find the min mse between importance weights
...
#####PD + DD + PG variations (integrate drug similarity and gene expression data)
    ...
    for j in range(5):
        ...
        for i in range(5):
            ...
            with open("predicted_data_in/folds_1_predicted/pg/R_pred_pg_par_{}_fold_{}.csv".format(j,i), "w") as f:
                writer = csv.writer(f, delimiter=",")
                writer.writerows(predicted_R)
...
#####PD + DD + PG + GG variations (integrate drug similarity, gene expression and gene-gene interaction data)
    ...
    for j in range(5):
        ...
        for i in range(5):
            ...
            with open("predicted_data_in/folds_1_predicted/gg/R_pred_gg_par_{}_fold_{}.csv".format(j,i), "w") as f:
                writer = csv.writer(f, delimiter=",")
                writer.writerows(predicted_R)
...
#use matrix-tri-factorization for drug-target data
    ...
    for j in range(5):
        ...
        for i in range(5):
            ...
            with open("predicted_data_in/folds_1_predicted/gd_mtf/R_pred_gd_par_{}_fold_{}.csv".format(j,i), "w") as f:
                writer = csv.writer(f, delimiter=",")
                writer.writerows(predicted_R)

            all_MSE[i] = performances['MSE']

        MSE_list_GD.append(all_MSE.mean())

    #find the min mse between importance weights
    index_min_MSE_GD = MSE_list_GD.index(min(MSE_list_GD))
...
# use matrix-bi-factorization for drug-target data
    ...
    for j in range(5):
        ...
        for i in range(5):
            ...
            with open("predicted_data_in/folds_1_predicted/gd_mf/R_pred_gd_par_{}_fold_{}.csv".format(j,i), "w") as f:
                writer = csv.writer(f, delimiter=",")
                writer.writerows(predicted_R)
